...
def graph2v2(fichier: pd.DataFrame,supp: str = None,nbr:int=15): # supp est une valeur à retirer, fichier et le fichier à analyser,nbr est le nombre de service à étudier
...
graph2v2(fichier=fichier,supp="-1",nbr=20)
